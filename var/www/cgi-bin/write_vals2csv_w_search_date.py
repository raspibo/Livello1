...
if FormName not in form:
    ...
    # Provo a spostare qua la fine pagina, cosi` il server web non odvrebbe andare in errore.
    # End web page
    print (mhl.MyHtmlBottom())
    print (subprocess.call(['/var/www/cgi-bin/valori2csv_search_date.py', RedisKey, RedisKeyStart, RedisKeyStop]))
