...
print (subprocess.call(['/sbin/start-stop-daemon','--start','--verbose', '--background', '--pidfile', '/var/run/mqtt2redis_d.pid', '--make-pidfile', '--startas', '/var/www/cgi-bin/mqtt2redis_d.py','--']))
print ("<h3>mqtt2redis_d.py started!</h3>")
